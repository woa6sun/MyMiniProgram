...
Page({
  ...
  toSearchResult:function(){
    ...
    var searchword = _this.data.detail.iName;
  ...
  collection: function () {
    ...
    if (!_this.data.isCollected) {
      ...
      var obj = new Object();
      obj.type = 3;
      obj.fid = _this.data.detail.f000;
      obj.name = _this.data.detail.iName;
  ...
  onLoad: function (options) {
    ...
    p.then(function (value) {
      let a = value.data;
      let flag = getApp().isCollected(3, a.f000);
      if (a.buesinessEntity != undefined){
        _this.setData({
          isTab:true
        })
      }
